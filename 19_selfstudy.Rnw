...
auf mehrere Stimuli reagieren.
 ...
 Andrew Gelman, Jennifer Hill und Aki Vehtari stellt
 eine ausführliche, zugängliche Einführung in
 die Arbeit mit Regressionsmodellen dar.
 Dabei scheut es realistischere, aber
 dafür komplexere Beispiele jedoch nicht.
