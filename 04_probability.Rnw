...
<<echo = FALSE, fig.cap = "Links: Wahrscheinlichkeit der Anzahl Erfolge bei der Binomial($10$, $1/6$)-Verteilung. Rechts: Verteilungsfunktion derselben Verteilung.\\label{fig:dbinom}", fig.width = 7, fig.height = 3.5, out.width=".8\\textwidth">>=
k <- 0:10
par(mfrow = c(1, 2))
