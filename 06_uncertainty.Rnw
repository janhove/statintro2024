...
dies in der Regel auch nicht genau, weshalb diese Ungenauigkeit
...
um Ungenauigkeit einzuschätzen.
...
\begin{itemize}
 ...
 annäherend normalverteilt, aber hiervon sind wir nicht a priori \emph{ausgegangen}.
...
davon \emph{ausgegangen}, dass die Stichprobenmittel aus
...
\mypar[exacte Vertrauensschranken für das Mittel einer Normalverteilung mit bekannter Varianz]{Beispiel}\label{bsp:ci_exact_norm}
  Sei $X_1, \dots, X_n$ eine Zufallsstichprobe unabhängiger Beobachtungen
...
\mypar[exacte Vertrauensschranken für das Mittel einer Normalverteilung mit unbekannter Varianz]{Beispiel}\label{bsp:ci_exact_t}
