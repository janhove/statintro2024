...
Das ist nämlich sehr praktisch, wenn Sie später eine Grafik mit leicht anderen
...
des Histogramms ist aber gleich, egal ob man mit Anzahlen oder
...
Beobachten wir beispielsweise die Zahlen $(0, 3, 4, 7)$,
so sind alle Zahlen im Intervall $[3, 4]$ Mediane dieser Beobachtungen.
In solchen Fällen bezeichnet man als \emph{den} Median das Mittel des
grössten und des kleinsten solchen Wertes, hier also $3.5$.
...
Um dies zu sehen, überlege man sich Folgendes:
\[
